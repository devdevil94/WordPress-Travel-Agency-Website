...
<?php 
	...
	function custom_styles_sctipts(){
		wp_enqueue_style('main-style', get_template_directory_uri() . '/style.css', false, '1.0', 'all');
		wp_enqueue_script('testimonial-slider', get_template_directory_uri().'/js/slider.js', array('jquery'), true);
	}
	...
	add_action('wp_enqueue_scripts', 'custom_styles_sctipts');
